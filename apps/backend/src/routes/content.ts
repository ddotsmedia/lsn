...
import { getHeading } from './admin/pageHeadings.js';
...
export function createPublicContentRouter(db: Pool): express.Router {
  ...
  // The H1 each page renders. Read-only; editing stays behind
  // /api/v1/admin/page-headings.
  router.get('/page-headings/:slug', (req, res) => getHeading(db, req as AuthRequest, res));
